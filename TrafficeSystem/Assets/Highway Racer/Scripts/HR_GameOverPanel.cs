...
public class HR_GameOverPanel : MonoBehaviour {
	...
	public int totalDistanceMoneyMP
	{
		get
		{
			return HighwayRacerProperties.Instance._totalDistanceMoneyMP;
		}
	}
	public int totalNearMissMoneyMP{
		get
		{
			return HighwayRacerProperties.Instance._totalNearMissMoneyMP;
		}
	}
	public int totalOverspeedMoneyMP{
		get
		{
			return HighwayRacerProperties.Instance._totalOverspeedMoneyMP;
		}
	}
	public int totalOppositeDirectionMP{
		get
		{
			return HighwayRacerProperties.Instance._totalOppositeDirectionMP;
		}
	}
