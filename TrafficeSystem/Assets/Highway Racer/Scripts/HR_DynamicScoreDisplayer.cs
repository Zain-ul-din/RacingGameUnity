...
public class HR_DynamicScoreDisplayer : MonoBehaviour {
	...
	public void DisplayScore (int score, float offset) {
		...
		timer = lifeTime;
		nearMissSound = CreateAudioSource.NewAudioSource (gameObject, HighwayRacerProperties.Instance.nearMissAudioClip.name, 0f, 0f, 1f, HighwayRacerProperties.Instance.nearMissAudioClip, false, true, true);
