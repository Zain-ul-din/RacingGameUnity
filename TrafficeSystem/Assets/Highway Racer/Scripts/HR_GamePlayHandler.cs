...
public class HR_GamePlayHandler : MonoBehaviour {
	...
	void Awake(){
		...
		if (HighwayRacerProperties.Instance.gameplayClips != null && HighwayRacerProperties.Instance.gameplayClips.Length > 0) {
			gameplaySoundtrack = CreateAudioSource.NewAudioSource (gameObject, "GamePlay Soundtrack", 0f, 0f, .35f, HighwayRacerProperties.Instance.gameplayClips [UnityEngine.Random.Range (0, HighwayRacerProperties.Instance.gameplayClips.Length)], true, true, false);
