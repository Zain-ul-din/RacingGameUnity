...
public class HR_Bomb : MonoBehaviour {
	...
	private AudioClip bombTimerAudioClip{get{return HighwayRacerProperties.Instance.bombTimerAudioClip;}}
	...
	void Start () {
		...
		bombTimerAudioSource = CreateAudioSource.NewAudioSource(gameObject, "Bomb Timer AudioSource", 0f, 0f, .25f, bombTimerAudioClip, false, false, false);
