...
[System.Serializable]
public class HighwayRacerProperties : ScriptableObject {

	public static HighwayRacerProperties instance;
	public static HighwayRacerProperties Instance {
		get {
			if(instance == null)
				instance = Resources.Load("HR_Assets/HR_HighwayRacerProperties") as HighwayRacerProperties;
			return instance;
		}
	}
